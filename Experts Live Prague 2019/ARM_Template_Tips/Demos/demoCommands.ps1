...
### 3_Outputs
New-AzResourceGroupDeployment -Name "3_outputs_1" -ResourceGroupName "igniteARMDemos" -TemplateFile .\3_Outputs\simpleOutput.json
$x=New-AzResourceGroupDeployment -Name "3_outputs_2" -ResourceGroupName "igniteARMDemos" -TemplateFile .\3_Outputs\objectOutput.json
...
New-AzResourceGroupDeployment -Name "3_outputs_3" -ResourceGroupName "igniteARMDemos" -TemplateFile .\3_Outputs\Variables.json
...
New-AzResourceGroupDeployment -Name "6_conditions_1" -ResourceGroupName "igniteARMDemos" -TemplateFile .\6_Conditions\if.json -TemplateParameterFile .\6_Conditions\if.params.json
